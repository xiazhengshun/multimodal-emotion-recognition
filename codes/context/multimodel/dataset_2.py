...
def load_dataset(data_path, encoder_path, mask_path, data_path1, encoder_path1, mask_path1, data_path2, encoder_path2, mask_path2, labels=None, min_length=3, max_length=None):
    sizes = []
    offsets = []
    emo_labels = []
    textsizes = []
...
def load_ssl_features(feature_path, encoder_path, mask_path, feature_path1, encoder_path1, mask_path1, feature_path2, encoder_path2, mask_path2, label_dict, max_speech_seq_len=None):
    data, sizes, offsets, labels , encoder_data, mask_data, textsizes, textoffsets, \
       data1, sizes1, offsets1, encoder_data1, mask_data1, textsizes1, textoffsets1,\
        ...
        load_dataset(feature_path, encoder_path, mask_path, feature_path1, encoder_path1, mask_path1, feature_path2, encoder_path2, mask_path2, labels='emo', min_length=1, max_length=max_speech_seq_len)
