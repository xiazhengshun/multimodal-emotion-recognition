...
def load_dataset(data_path, encoder_path, mask_path, data_path1, encoder_path1, mask_path1, data_path2, encoder_path2,\
    mask_path2, data_path3, encoder_path3, mask_path3, data_path4, encoder_path4, mask_path4, labels=None, min_length=3, max_length=None):
    sizes = []
    offsets = []
    emo_labels = []
    textsizes = []
    ...
    def __getitem__(self, index):
        ...
        res = {"id": index, "feats": feats, "texts_id": texts_id, "texts_mask": texts_mask, "feats1": feats1,\
                ...
                "texts_mask2": texts_mask2, "feats3": feats3, "texts_id3": texts_id3, "texts_mask3": texts_mask3,\
                  "feats4": feats4, "texts_id4": texts_id4, "texts_mask4": texts_mask4}
...
def load_ssl_features(feature_path, encoder_path, mask_path, feature_path1, encoder_path1, mask_path1, feature_path2,\
    encoder_path2, mask_path2, feature_path3, encoder_path3, mask_path3, feature_path4, encoder_path4, mask_path4, label_dict, max_speech_seq_len=None):
    data, sizes, offsets, labels , encoder_data, mask_data, textsizes, textoffsets, \
       data1, sizes1, offsets1, encoder_data1, mask_data1, textsizes1, textoffsets1,\
        ...
        load_dataset(feature_path, encoder_path, mask_path, feature_path1, encoder_path1, mask_path1, feature_path2, \
            encoder_path2, mask_path2, feature_path3, encoder_path3, mask_path3, feature_path4, encoder_path4, mask_path4, labels='emo', min_length=1, max_length=max_speech_seq_len)
