...
from model_5 import Multimodel, validate_and_test
import numpy as np
...
dataset = load_ssl_features(
    ...
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/predict/bertlarge',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/predict/bertlargemask',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev1/Session_prev1',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev1/bertlarge_prev1',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev1/bertlargemask_prev1',    
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev2/Session_prev2',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev2/bertlarge_prev2',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev2/bertlargemask_prev2',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev3/Session_prev3',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev3/bertlarge_prev3',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev3/bertlargemask_prev3',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev4/Session_prev4',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev4/bertlarge_prev4',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev4/bertlargemask_prev4',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev5/Session_prev5',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev5/bertlarge_prev5',
    '/hpc_stor03/sjtu_home/zhengshun.xia/need/codes/context/datastore/prev5/bertlargemask_prev5',
    label_dict,
    )
fold_sizes = [1085, 1023, 1151, 1031, 1241] # Session1, 2, 3, 4, 5
fold_list = [0, 1, 2, 3, 4]
test_wa_avg, test_ua_avg, test_f1_avg = 0., 0., 0.
log_name = 'multimodel_emotion_recognition_prev5'
...
for fold in fold_list:
    ...
    for epoch in range(100):  # Adjust the number of epochs as per your requirement
        ...
        for batch in train_loader:
            ...
            optimizer.zero_grad()
            outputs = model(feat1, padmask1, text1, mask1, feat2, padmask2, text2, mask2, feat3, padmask3, text3, mask3,\
                           feat4, padmask4, text4, mask4, feat5, padmask5, text5, mask5, feat, padmask, text, mask)
