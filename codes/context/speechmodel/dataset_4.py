...
def load_dataset(data_path, data_path1, data_path2, data_path3, data_path4, labels=None, min_length=3, max_length=None):
    sizes = []
    offsets = []
    emo_labels = []
    ...
    return npy_data, sizes, offsets, emo_labels, npy_data1, sizes1, offsets1, npy_data2, sizes2, offsets2,\
           npy_data3, sizes3, offsets3, npy_data4, sizes4, offsets4
...
class SpeechDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        res = {"id": index, "feats": feats, "feats1": feats1, "feats2": feats2,  "feats3": feats3, "feats4": feats4}
...
def load_ssl_features(feature_path, feature_path1, feature_path2, feature_path3, feature_path4, label_dict, max_speech_seq_len=None):
    data, sizes, offsets, labels, data1, sizes1, offsets1, data2, sizes2, offsets2, data3, sizes3, offsets3, data4, sizes4, offsets4, = \
        load_dataset(feature_path, feature_path1, feature_path2, feature_path3, feature_path4, labels='emo', min_length=1, max_length=max_speech_seq_len)
