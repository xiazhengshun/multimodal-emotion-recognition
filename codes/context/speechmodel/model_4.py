...
def validate_and_test(model, data_loader, device, num_classes):
    ...
    with torch.no_grad():
        ...
        for batch in data_loader:
            ...
            ids, net_input1, net_input2, net_input3, net_input4, net_input , labels = batch["id"], batch["net_input1"], batch["net_input2"], \
                                                                            batch["net_input3"],  batch["net_input4"], batch["net_input"], batch["labels"]
            ...
            outputs = model(feats1, speech_padding_mask1, feats2, speech_padding_mask2 , feats3, speech_padding_mask3, feats4, speech_padding_mask4, feats, speech_padding_mask)
