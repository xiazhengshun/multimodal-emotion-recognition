...
from model_2 import BaseModel, validate_and_test
...
log_name = 'speech_emotion_recognition_2'
...
for fold in fold_list:
    ...
    for epoch in range(100):  # Adjust the number of epochs as per your requirement
        ...
        for batch in train_loader:
            ids, net_input1, net_input2, net_input , labels = batch["id"], batch["net_input1"], batch["net_input2"], batch["net_input"], batch["labels"]
            ...
            optimizer.zero_grad()
            outputs = model(feats1, speech_padding_mask1, feats2, speech_padding_mask2 ,feats, speech_padding_mask)
