...
class BaseModel(nn.Module):
    def __init__(self, input_dim=768, output_dim=4):
        ...
        self.post_net = nn.Linear(128 * 4, output_dim)
...
def validate_and_test(model, data_loader, device, num_classes):
    ...
    with torch.no_grad():
        ...
        for batch in data_loader:
            ...
            ids, net_input1, net_input2, net_input3, net_input , labels = batch["id"], batch["net_input1"], batch["net_input2"], \
                                                                            batch["net_input3"], batch["net_input"], batch["labels"]
